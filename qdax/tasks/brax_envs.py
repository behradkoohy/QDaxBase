...
def create_default_brax_task_components(
    ...
    Returns:
        ...
        random_key: The updated random key.
    """
    env = brax.create(env_name, episode_length=episode_length)
    ...
    bd_extraction_fn = brax.descriptor_extractor[env_name]
    # bd_extraction_fn = brax.descriptor_extractor[env_name]
